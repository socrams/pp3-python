...
class MessageProcessor:
    ...
    def __init__(self) -> None:
        ...
        self.responses=[
            ...
            Response(1, "hola", "¡Hola! ¿En qué puedo ayudarte?", "", False, False),
            Response(2, "buenos dias", "¡Buen día! ¿En qué puedo ayudarte?", "", False, False),
